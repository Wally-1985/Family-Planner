...
- User Profiles currently control app/sidebar visibility only. Administrator PINs and reset email links are local convenience locks, not a substitute for server-side authentication and API authorization.
