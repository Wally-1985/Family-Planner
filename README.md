...
- Settings:
  ...
  - User Profiles for startup profile selection, Administrator PINs, and sidebar/page visibility permissions
...
- User Profiles currently control app/sidebar visibility only. Administrator PINs are local convenience locks, not a substitute for server-side authentication and API authorization.
